	...
	<main class="py-16 lg:py-20">
		<div class="container">
			...
			<section class="flex flex-col lg:flex-row gap-10 xl:gap-14 2xl:gap-20 mt-12">
				...
				<div class="basis-full lg:basis-2/5 xl:basis-2/4">
					<div class="overflow-hidden h-auto max-h-[620px] lg:h-[480px] xl:h-[620px] rounded-3xl">
						<img src="{{ $product->makeImage('345x320') }}" class="object-cover w-full h-full"
							 alt="{{ $product->title }}">
					</div>
				</div>
			...
			<section class="mt-16 xl:mt-24">
				...
				<!-- Products list -->
				<div
					class="products grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-x-8 gap-y-8 lg:gaps-y-10 2xl:gap-y-12">
